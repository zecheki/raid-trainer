...
export const MECHANIC = Object.freeze({
  ...
  LANE_ANGLE_GAPS: [35, 20, 35, 35, 20, 35, 35, 20, 35, 35, 20, 35],
  ACTIVE_LANE_COUNT: 2,
  ORB_RADIUS: 2,
  ORB_SPEED: 6,
  ORB_START_DISTANCE: ARENA.RADIUS - 150,
  ORB_SPACING: 32,
  ...
  SHIELD_BASE_RADIUS: ARENA.BOSS_RADIUS + 6,
  SHIELD_GAP: 4,
  SHIELD_LINE_WIDTH: 4,
  SHIELD_GLOW_OFFSET: 4,
  BEAM_INTERVAL: 3,
  BEAM_TELEGRAPH_TIME: 0.9,
  BEAM_LOCK_BEFORE_FIRE: 0.5,
  BEAM_ACTIVE_TIME: 0.32,
  MAX_BEAMS: 7,
  BEAM_WIDTH: 8,
  CIRCLE_AOE_ENABLED: true,
  CIRCLE_AOE_FIRST_DELAY: 1.5,
  CIRCLE_AOE_INTERVAL: 5.0,
  CIRCLE_AOE_MAX_COUNT: Number.POSITIVE_INFINITY,
