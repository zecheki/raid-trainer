...
오른쪽 HUD의 `난이도 옵션` 체크박스는 시작 전에만 변경할 수 있습니다. 게임이 진행 중일 때는 체크박스가 비활성화됩니다.
...
- 원형장판에 맞으면 실패
- 담당 밖 오브 표시
- 담당 밖 오브를 직선장판에 맞추면 실패

기본값은 `src/core/constants.js`의 `DIFFICULTY_OPTION_DEFAULTS`에서 조절할 수 있습니다.
